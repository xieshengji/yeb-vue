  ...
  <div>
    <el-card class="box-card" style="width: 400px">
      ...
      <div>
        ...
        <div>住宅电话：<el-tag>{{admin.telephone}}</el-tag></div>
        <div>手机号码：<el-tag>{{admin.phone}}</el-tag></div>
        <div>居住地址：<el-tag>{{admin.address}}</el-tag></div>
        <div>角色名称：<el-tag type="success" v-for="(r, index) in admin.roles" :key="index">{{r.nameZh}}</el-tag></div>
    ...
    <el-dialog
      ...
      <div>
        <table>
          ...
          <tr>
            <td>居住地址：</td>
            <td><el-input v-model="updateAdmin.address"></el-input></td>
          </tr>
        </table>
      </div>
